...
public class BarrierTable implements IBarrierTable<Integer, Pair<Integer, List<Integer>>> {
    ...
    private BarrierTable(HashMap<Integer, Pair<Integer, List<Integer>>> dictionary) {
        this.map = dictionary;
    }
...
//    @Override
//    public IBarrierTable<Integer, Pair<Integer,List<Integer>>> deepCopy() {
...
//        }
//        return new BarrierTable(newMap);
//    }
}
